...
from ENCAPSULATION.Exercises.football_team_generator.project.player import Player
from ENCAPSULATION.Exercises.football_team_generator.project.team import Team
